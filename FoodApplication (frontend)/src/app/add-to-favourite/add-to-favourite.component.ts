...
export class AddToFavouriteComponent implements OnInit {
  ...
  constructor(
    ...
    private comp: NavigationUserComponent
  ) {}
  ngOnInit(): void {
  ...
  addtoCart(
    ...
    this.http.post<any>('http://localhost:9000/addToCart/post', fav).subscribe(
      (success) => {
        console.log(success);
        iziToast.success({
          title: 'Success',
  ...
  deletefromFavourite(
    ...
    return this.http
      .delete(
        'http://localhost:9000/addToFavourite/delete/favourite/' +
